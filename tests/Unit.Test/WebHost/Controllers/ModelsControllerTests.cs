...
namespace Unit.Test.WebHost.Controllers
{
    ...
    {
        private readonly Mock<ICarModelService> _serviceMock;
        private readonly ModelsController _controller;

        public ModelsControllerTests()
        {
            _serviceMock = new Mock<ICarModelService>();
            _controller = new ModelsController(_serviceMock.Object);
        }
        ...
        public async Task GetById_ShouldReturnOk_WhenExists()
        {
            // Arrange
            var id = Guid.NewGuid();
            var expectedResponse = GenerateCarModelResponse(id);
        ...
        public async Task GetById_ShouldReturnNotFound_WhenMissing()
        {
            ...
            _serviceMock
                .Setup(x => x.GetByIdAsync(id, It.IsAny<CancellationToken>()))
                .ReturnsAsync((CarModelResponse?)null);
        ...
        {
            // Arrange
            var request = GenerateCarModelResponses(3);
        ...
        {
            // Arrange
            var request = GenerateCreateCarModelRequest();
            var createdId = Guid.NewGuid();
            var expectedResponse = new CarModelResponse { Id = createdId, Name = request.Name };
        ...
        public async Task Update_ShouldReturnOk()
        {
            // Arrange
            var id = Guid.NewGuid();
            var request = GenerateUpdateCarModelRequest();
            var updatedResponse = new CarModelResponse { Id = id, Name = request.Name };
        ...
        private List<CarModelResponse> GenerateCarModelResponses(int count = 3)
        {
            return new Faker<CarModelResponse>()
                .RuleFor(b => b.Id, f => f.Random.Guid())
                .RuleFor(b => b.Name, f => f.Company.CompanyName())
                .Generate(count);
        }

        private CarModelResponse GenerateCarModelResponse(Guid id)
        {
            return new Faker<CarModelResponse>()
                .RuleFor(b => b.Id, id)
                .RuleFor(b => b.Name, f => f.Company.CompanyName())
        ...
        private CreateCarModelRequest GenerateCreateCarModelRequest()
        {
        ...
        private UpdateCarModelRequest GenerateUpdateCarModelRequest()
        {
