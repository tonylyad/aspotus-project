...
namespace Unit.Test.WebHost.Controllers
{
    public class BrandsControllerTests
    {
        ...
        public BrandsControllerTests()
        {
            ...
            _controller = new BrandsController(_serviceMock.Object);
        }
        ...
        public async Task GetById_ShouldReturnOk_WhenExists()
        {
            // Arrange
            var id = Guid.NewGuid();
            var expectedResponse = GenerateCarBrandResponse(id);
        ...
        public async Task GetById_ShouldReturnNotFound_WhenMissing()
        {
            ...
            _serviceMock
                .Setup(x => x.GetByIdAsync(id, It.IsAny<CancellationToken>()))
                .ReturnsAsync((BrandResponse?)null);
        ...
        {
            // Arrange
            var request = GenerateCarBrandResponses(3);
        ...
        public async Task Create_ShouldReturnCreated_WhenSuccessful()
        {
            ...
            var expectedResponse = new BrandResponse { Id = createdId, Name = request.Name };
        ...
        public async Task Update_ShouldReturnOk()
        {
            ...
            var updatedResponse = new BrandResponse { Id = id, Name = request.Name };
        ...
        private List<BrandResponse> GenerateCarBrandResponses(int count = 3)
        {
        ...
        private BrandResponse GenerateCarBrandResponse(Guid id)
        {
            return new Faker<BrandResponse>()
                .RuleFor(b => b.Id, id)
                .RuleFor(b => b.Name, f => f.Company.CompanyName())
